...
class TeamLeaderController extends Controller
{
    ...
    public function storeReturnDevices(Request $request, \App\Services\TeamLeaderDeviceReturnService $returnService)
    {
        ...
        try {
            ...
            $message = $count === 1
                ? 'Return request sent to your regional manager. They must accept before devices leave your custody.'
                : "{$count} devices submitted for return. Your regional manager must accept the request.";
        } catch (\InvalidArgumentException $e) {
            return back()->withInput()->with('error', $e->getMessage());
        }

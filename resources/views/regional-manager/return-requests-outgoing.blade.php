<x-regional-manager-layout title="My return requests">
    <div class="admin-prod-page !pt-4 sm:!pt-6">
        <div class="admin-prod-toolbar !mb-6">
            <div>
                ...
                <p class="mt-1 text-slate-600">Devices you submitted to return to admin. Pending requests can be cancelled.</p>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($returns as $r)
                        <tr>
                            ...
                            <td class="px-4 py-3 text-slate-900">Admin</td>
                            ...
                            <td class="px-4 py-3">
                                @if($r->status === 'pending')
                                    <form method="POST" action="{{ route('regional-manager.return-requests.outgoing.cancel', $r->id) }}" class="inline"

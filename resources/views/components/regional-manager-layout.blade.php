        ...
        <div
            ...
            <div
                ...
                <a href="{{ route('regional-manager.transfers.index') }}"
                    class="px-3 py-1.5 rounded-xl shrink-0 inline-flex items-center gap-1.5 {{ request()->routeIs('regional-manager.transfers*') ? 'bg-white/90 text-[#232f3e] shadow-sm' : 'text-slate-600 hover:text-[#232f3e] hover:bg-white/70' }} transition-all">
                    Transfer requests
                ...
                <a href="{{ route('regional-manager.return-requests.incoming') }}"
                    class="px-3 py-1.5 rounded-xl shrink-0 inline-flex items-center gap-1.5 {{ request()->routeIs('regional-manager.return-requests*') ? 'bg-white/90 text-[#232f3e] shadow-sm' : 'text-slate-600 hover:text-[#232f3e] hover:bg-white/70' }} transition-all">
                    Return requests
            ...
            <nav class="flex-1 px-3 py-4 space-y-6">
                <div>
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('regional-manager.return-requests.incoming') }}"
                            class="admin-sidebar-item {{ request()->routeIs('regional-manager.return-requests*') ? 'admin-sidebar-item-active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"

        ...
        <div class="max-w-6xl mx-auto px-4 py-10 flex flex-col sm:flex-row justify-between gap-6 text-sm">
            ...
            <nav class="flex flex-wrap gap-x-6 gap-y-2" aria-label="Footer">
                ...
                <a href="{{ route('delete-account') }}"
                    class="cursor-pointer hover:text-white transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#fa8900] rounded">Delete account</a>
            </nav>
        </div>

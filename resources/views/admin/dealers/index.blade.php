<x-admin-layout>
    ...
    <div class="admin-prod-page">
        ...
        <div class="mt-6 admin-clay-panel overflow-hidden">
                ...
                <table class="min-w-[980px]" data-no-datatable>
                    <thead>
                        <tr>
                            ...
                            @include('admin.partials.user-sortable-th', ['column' => 'business_name', 'label' => 'Business Name', 'sort' => $sort, 'direction' => $direction])
                            ...
                            @include('admin.partials.user-sortable-th', ['column' => 'created_at', 'label' => 'Registered', 'sort' => $sort, 'direction' => $direction])
            ...
            @include('admin.partials.table-pagination', ['paginator' => $dealers, 'label' => 'dealers'])
        </div>
    </div>
</x-admin-layout>
